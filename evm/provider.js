...
function getProvider(network, bFree) {
	...
	switch (network) {
		...
		case 'BSC':
			return new ethers.providers.JsonRpcProvider(process.env.testnet ? `https://speedy-nodes-nyc.moralis.io/${cond.moralis_key}/bsc/testnet` : `https://speedy-nodes-nyc.moralis.io/${conf.moralis_key}/bsc/mainnet`);
